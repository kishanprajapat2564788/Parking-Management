...
<head>
    ...
    <title>Parking Manangement- Add Category</title>
   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Enter Vehicle Category" required="true"></div>
                                    </div>
